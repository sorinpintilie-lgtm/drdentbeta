          ...
          answer: (
            <>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Sunați-ne la: <a href="tel:+40213449317" className="text-primary-600 hover:text-primary-700 font-semibold">+40 21 344 9317</a></li>
                <li>Trimiteți-ne un email la: <a href="mailto:contact@drdent.ro" className="text-primary-600 hover:text-primary-700 font-semibold">contact@drdent.ro</a></li>
              </ul>
            </>
          ),
        },
